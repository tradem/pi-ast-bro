# ast-context-pilot Specification

## Purpose
Token-budgeted focused context retrieval for individual symbols, reducing whole-file reads for "how does this work?" questions.
