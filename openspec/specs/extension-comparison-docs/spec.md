# extension-comparison-docs Specification

## Purpose
Provide an honest decision-aid in the README that contrasts the `pi-ast-bro` extension with the upstream `ast-bro` skill and managed indexing/graph tools across stable, decision-relevant axes.
